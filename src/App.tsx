      ...
      <div className="bg-custom-brown1 relative">
        ...
        <section className="py-20 bg-custom-brown text-center">
          ...
          <div className="flex flex-col md:flex-row items-stretch justify-center gap-8 px-6">
            <div
              className="flex flex-col items-center bg-white rounded-2xl p-6 shadow-lg max-w-sm flex-1 h-full"
              data-aos="fade-right"
            >
              ...
              <p className="oswald text-lg text-gray-700 flex-grow">
                "La migliore pizza senza glutine che abbia mai provato! Sapore
                autentico e servizio impeccabile."
              </p>
            </div>
            ...
            >
              ...
              <p className="oswald text-lg text-gray-700 flex-grow">
                "Un'esperienza unica! Gli antipasti e le pizze sono
                spettacolari, tornerò sicuramente."
              </p>
            </div>
            ...
            >
              ...
              <p className="oswald text-lg text-gray-700 flex-grow">
                "Ambiente accogliente e pizze deliziose. Perfetto per una serata
                speciale, servizio impeccabile !!"
              </p>
            </div>
          </div>
        </section>
