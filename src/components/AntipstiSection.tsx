import { antipastiItems } from "./antipastiData";
import type { Antipasto } from "./antipastiData";
import { Badge } from "./Badge";

export default function AntipastiSectioni() {
  return (
    <section className="py-10">
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {antipastiItems.map((item: Antipasto) => (
          <div
            key={item.id}
