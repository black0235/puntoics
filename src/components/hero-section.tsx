...
export default function HeroSection({ onGSAPLoad }: HeroSectionProps) {
  ...
  return (
    <div
      ref={heroRef}
      className="flex bg-video-container h-screen relative overflow-hidden"
    >
      <video
        autoPlay
        loop
      ...
      <div className="flex flex-col-reverse lg:flex-row sm:p-0 lg:p-6 m-5 md:m-28 gap-5 bg-transparent z-10">
        <div className="text-left mt-16 w-full lg:w-1/2">
          <h1 className="hero-title oswald text-4xl md:text-6xl lg:text-7xl text-white mb-6 drop-shadow-lg">
            Da noi la qualità è di casa, il gusto è una certezza!
          </h1>
          <p className="hero-subtitle oswald text-lg md:text-2xl mt-10 text-white leading-relaxed">
            Abbiamo soddisfatto{" "}
            <span className="font-semibold ">oltre 1000+ clienti...</span> con
            le nostre pizze, ora è il tuo turno!
          </p>
          <button
